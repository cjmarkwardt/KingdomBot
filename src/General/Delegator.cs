...
public static class Delegator
{
    ...
    public static Delegate CreateDelegate(Type delegateType, Expression<Implementation> implementation)
    {
        ...
        MethodInfo addMethod = argumentsType.GetMethod(nameof(System.Collections.IDictionary.Add)).NotNull();
        MethodInfo clearMethod = argumentsType.GetMethod(nameof(System.Collections.IDictionary.Clear)).NotNull();
